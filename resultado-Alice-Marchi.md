...
| respostas.js - R2 | consulta a tabela produtos selecionando nome e preço | ✅ | ❌ | AssertionError: expected 'select * from produtos where preco or…' to match /\bnome\b/i |
