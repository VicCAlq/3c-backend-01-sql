...
| respostas.js - R1 | inclui as cidades Jaboatão dos Guararapes e Olinda | ✅ | ❌ | AssertionError: expected 'select nome, telefone, cidade from cl…' to match /["']jaboatão\s+dos\s+guararapes["']/i |
