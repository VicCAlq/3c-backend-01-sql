/* Exercício 1:
  ...
  */
export const r1 = `SELECT cidade FROM clientes WHERE cidade IN ('Jaboatão dos Guararapes', 'Olinda')`
...
/* Exercício 3:
  ...
  * e Novembro (11)
  */
export const r3 = `SELECT id, data_pedido FROM pedidos WHERE data_pedido BETWEEN '2025-12-12' and '2025-12-18'`
