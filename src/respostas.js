/* Exercício 1:
  ...
  */
export const r1 = ` select nome from clientes where cidade in('Jaboatão dos Guararapes', 'Olinda');`
...
/* Exercício 3:
  ...
  * e Novembro (11)
  */
export const r3 = `select nome, data_pedido from pedidos where data_pedido between '2025-12-12' and '2025-12-18'; `
