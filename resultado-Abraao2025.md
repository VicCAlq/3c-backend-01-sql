Data de atualização: Dia 28/8/2026 às 11:6 
...
| respostas.js - R1 | inclui as cidades Jaboatão dos Guararapes e Olinda | ✅ | ❌ | AssertionError: expected 'SELECT cidade FROM clientes\nwhere ci…' to match /["']olinda["']/i |
